...
DEFAULT_HUB_MODEL_ID = "YOUR_HF_USERNAME/ayda-qwen2.5-1.5b-tr-seed-lora-v1"
...
def main() -> None:
    ...
    args = SFTConfig(
        output_dir="ayda-qwen2.5-1.5b-tr-seed-lora-v1",
        ...
        run_name="qwen2.5-1.5b-tr-seed-sft-v1",
    )
