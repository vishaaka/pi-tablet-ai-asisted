...
from ayda.core.router import Router
from ayda.core.session import AydaSession
from ayda.core.state_machine import StateMachine
from ayda.dialogue.intents import classify_intent
from ayda.dialogue.templates import choose_template
...
class DialogueManager:
    ...
    def _delegate_to_pc(self, text: str, session: AydaSession) -> str:
    ...
    def process(self, text: str, session: AydaSession) -> ResponseObject:
