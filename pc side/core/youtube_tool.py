...
from storage.db import profil_getir
...
def youtube_ara(query):
    ...
    suffix = str(youtube_settings.get("query_suffix", "")).strip()
    ...
    params = {
        "key": youtube_settings["api_key"],
        "q": query,
        "part": "snippet",
        "type": "video",
        "safeSearch": youtube_settings.get("safe_search", "strict"),
        "maxResults": int(youtube_settings.get("max_results", 12)),
    }
