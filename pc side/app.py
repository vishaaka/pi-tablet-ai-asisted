...
from youtube_tool import youtube_ara
from db import izleme_kaydet, profil_guncelle
from speech import speech_kaydet, konusma_analiz, konusma_seviyesi
from ai_engine import ai_oneri
